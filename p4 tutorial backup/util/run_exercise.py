...
class ExerciseTopo(Topo):
    ...
    def __init__(self, hosts, switches, links, log_dir, **opts):
        ...
        for link in host_links:
            ...
            host_ip = "2001:%d:1:0:0:0:0:1" % (host_num)
            host_gw = "2001:%d:1:0:0:0:0:ff" % (host_num)
            ...
            h1a = self.addHost(host_name, cls=IPv6Host, mac = host_mac,
                               ipv6=host_ip+'/64', ipv6_gw=host_gw)
