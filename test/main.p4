...
control EgressPipeImpl (inout parsed_headers_t hdr,
    ...
    action add_swtrace1() {
        ...
        //hdr.swtraces1[0].swid = (switchID_t)swid;
        ...
        hdr.ipv6.payload_len = hdr.ipv6.payload_len + 9;
    }
    ...
    action add_swtrace2() {
        ...
        //hdr.swtraces2[0].swid = (switchID_t)swid;
        ...
        hdr.ipv6.payload_len = hdr.ipv6.payload_len + 23;
    }
